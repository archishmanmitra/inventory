      ...
      {user?.role === "ADMIN" ? (
        ...
        >
          <TabsList className="bg-gray-100 border-2 border-gray-200 rounded-xl p-1 h-auto">
            <TabsTrigger
              value="all"
              className="data-[state=active]:bg-emerald-600 data-[state=active]:text-white data-[state=active]:rounded-lg px-4 py-2 font-semibold transition-all"
            >
              All Invoices
            </TabsTrigger>
            <TabsTrigger
          ...
          <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-6">
              ...
              <div className="border rounded-lg p-4 space-y-3">
                ...
                <div className="grid grid-cols-2 gap-3 text-sm">
                  ...
                  <div>
                    ...
                    <p>
                      {viewInvoice.taxInvDate
                        ? formatDate(viewInvoice.taxInvDate)
                        : "-"}
                    </p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p>
                      {viewInvoice.chalanDate
                        ? formatDate(viewInvoice.chalanDate)
                        : "-"}
                    </p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p>
                      {viewInvoice.orderDate
                        ? formatDate(viewInvoice.orderDate)
                        : "-"}
                    </p>
                  </div>
                  <div>
                  ...
                  <div>
                    <Label>Due On</Label>
                    <p>
                      {viewInvoice.dueOn ? formatDate(viewInvoice.dueOn) : "-"}
                    </p>
                  </div>
                ...
                <div className="border rounded-lg p-4 space-y-2 text-sm">
                  ...
                  {viewInvoice.discountAmount > 0 && (
                    <>
                      <div className="flex justify-between text-orange-600">
                        ...
                        <span>
                          -{formatCurrency(viewInvoice.discountAmount)}
                        </span>
                      </div>
                      <div className="flex justify-between border-t pt-2">
                        ...
                        <span className="font-medium">
                          {formatCurrency(
                            viewInvoice.totalAmount - viewInvoice.discountAmount
                          )}
                        </span>
                      </div>
                    </>
                  ...
                  {viewInvoice.transportCharges > 0 && (
                    <>
                      <div className="flex justify-between text-green-600">
                        ...
                        <span>
                          {formatCurrency(viewInvoice.transportCharges)}
                        </span>
                      </div>
                      <div className="flex justify-between border-t pt-2">
                  ...
                  {(viewInvoice.sgstAmount > 0 ||
                    ...
                    <div className="flex justify-between border-t pt-2">
                      ...
                      <span className="font-medium">
                        {formatCurrency(viewInvoice.netAmount)}
                      </span>
                    </div>
                  )}
              ...
              <div className="border rounded-lg p-4 space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  {/* Terms & Conditions */}
                  <div className="col-span-2 lg:col-span-1 border rounded p-3">
                    <h4 className="font-semibold text-sm mb-2">
                      Terms & Conditions
                    </h4>
                    <p className="whitespace-pre-wrap text-xs">
                      {viewInvoice.termsAndConditions || "N/A"}
                    </p>
                  </div>
                  ...
                  <div className="col-span-2 lg:col-span-1 border rounded p-3">
                    {/* Certified Section */}
                    <p className="text-xs mb-4 border-b pb-2">
                    ...
                    <div className="grid grid-cols-2 gap-8 mt-4">
                      ...
                      <div className="ml-2">
                        <div className="text-left text-xs space-y-1">
                          <div>
                            <p className="font-semibold text-[0.65rem]">Digitally signed by: {viewInvoice.signatureBy || "M/S Enterprise"}</p>
                          </div>
                          <div>
                            <p className="text-[0.65rem]">Reason: I am approving this document</p>
                          </div>
                          <div>
                            <p className="text-[0.65rem]">
                              Date: {new Date(viewInvoice.createdAt).toLocaleString()}
                            </p>
                          </div>
                        </div>
                      </div>

                      {/* Right: Signature space only */}
                      <div className="text-right">
                        <div className="border-b border-gray-400 mb-2 min-h-16"></div>
                        <div className="mt-4">
                          <p className="font-semibold">
                            {viewInvoice.signatureBy || ""}
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    {/* Bottom left: E. & O. E. */}
                    <p className="text-xs mt-4 text-gray-600">E. &amp; O. E.</p>
                  </div>
                </div>
              </div>
            </div>
